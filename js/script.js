...
// certificate
gsap.from('.certificate h1', {scrollTrigger:'.certificate h1', opacity: 0, duration: 1, delay: 0.7, y: -30})
gsap.from('.certificate .line', {scrollTrigger:'.certificate .line', opacity: 0, duration: 1, delay: 0.9, y: -30})
gsap.from('.certificate-row', {scrollTrigger:'.certificate-row', opacity: 0, duration: 1, delay: 0.9, y: 30, stagger: 0.2})
